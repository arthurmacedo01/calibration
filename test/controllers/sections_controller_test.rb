...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference("Section.count") do
      post sections_url, params: { section: { acronym: @section.acronym, name: @section.name } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { acronym: @section.acronym, name: @section.name } }
